...
export default function Header() {
  ...
  return (
    ...
    <>
      <ul className="z-10 w-full text-black h-24 bg-blue-300/75 flex backdrop-blur-md justify-center lg:justify-start items-center top-0 fixed">
        <Link to="/" className="h-full">
          <div className=" h-full hover:bg-blue-400 flex items-center pl-2">
            <li className="pl-8  text-3xl pr-8 text-center ">Stephen Ripple</li>
          </div>
        </Link>
        ...
        <div className=" h-full hover:bg-blue-400 hover:cursor-pointer flex items-center pl-2">
          <li className=" text-black text-2xl pr-2">Other</li>
        </div>
      </ul>
    </>
  );
